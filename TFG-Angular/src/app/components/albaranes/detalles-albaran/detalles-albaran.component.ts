...
//Función para recuperar los datos de los pedidos que se quiere mostrar en el albarán, estos datos se le pasan al formulario.
...
//mediente el metodo getPedido.
  getPedido(){
  	this._pedidoService.getPedido(this.id_pedido).subscribe(
        ...
        for (let pedido of pedidos){
          ...
          //Se llama al metodo getCliente para obtener los datos del cliente al que pertenece el albarán.
  ...
  //Función para recuperar los datos de la empresa que se quieren mostrar en el albarán, estos datos se le pasan al formulario.
...
//Función que genera el albarán con todos los datos.
  ...
  //Bucle para recorrer todas las lineas del pedido.
    ...
    doc.save('albaran-'+this.pedido.id+'.pdf');
  ...
  //Recuadro superior de las lineas del albarán
  ...
  //Recuadro inferior de las lineas del albarán
  doc.setFillColor(141, 73, 37);
