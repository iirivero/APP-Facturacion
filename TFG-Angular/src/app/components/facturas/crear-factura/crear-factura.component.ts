...
export class CrearFacturaComponent implements OnInit {
   ...
   * _facturaService: Para crear una nueva factura.
  ...
  //Función para crear las diferentes facturas en el sistema, en esta función se añaden todos
  //los datos del cliente, pasandole el id de ese cliente al servicio
  //para que este se comunique con la API REST para poder añadir la factura en la base de datos.
  crearFactura(cliente: Cliente): void {
    ...
    response => {
      ...
      for (let factura of response){
        //Te redirecciona a otra pagina para seleccionar los pedidos.
        this._router.navigate(['/rellenar-factura',factura.id,cliente.id]);
      }
